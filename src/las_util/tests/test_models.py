...
class SectionInfoModelTests(TestCase):
    mimetype = 'text/html'
    ...
    def test_fixture_loading(self):
        self.assertEqual(22, SectionInfo.objects.count())
        pList = SectionInfo.objects.all()
        self.assertEqual(22, len(pList))

    def test_label_filename(self):
        item = SectionInfo.objects.get(pk=1)
